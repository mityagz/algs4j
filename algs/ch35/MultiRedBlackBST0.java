 ...
 */
public class MultiRedBlackBST0<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String [] args) {
        MultiRedBlackBST0<String, Integer> st = new  MultiRedBlackBST0<String, Integer>();
        /*
